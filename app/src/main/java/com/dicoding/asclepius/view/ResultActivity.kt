...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val resultViewModel = ViewModelProvider(this, factory).get(ResultViewModel::class.java)
        ...
        resultViewModel.fetchHistoryData(image).observe(this) { data ->
            binding.btnSave.setOnClickListener {
                if (data == null) {
                    resultViewModel.insert(image, label, score)
                    Toast.makeText(
                        this, "Successfully saved to history", Toast.LENGTH_SHORT
                    ).show()
                } else {
                    Toast.makeText(
                        this, "Already saved to history", Toast.LENGTH_SHORT
                    ).show()
                }
            }
        }
